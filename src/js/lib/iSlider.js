...
(function (global) {
    ...
    iSliderPrototype._renderItem = function (el, dataIndex) {
        ...
        var insertImg = function () {
            ...
            //console.log('insertImg simg',simg);
            ...
            case 'pic':
                if (item.height && item.width) {
                    ...
                    currentImg.onload = function () {
                        //console.log('0 loaded',currentImg,currentImg.width);
            ...
            var loadImg = function preloadImgLoadingProcess(index) {
                ...
                if (self._itemType(item) === 'pic' && !item.loaded) {
                    ...
                    preloadImg.onload = function () {
                        //console.log('1 loaded',preloadImg,preloadImg.width);
